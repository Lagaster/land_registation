...
<div class="container-fluid">
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h4 class="text-themecolor">StampDuty Updates</h4>
        </div>
    ...
    <div class="row">
        <div class="card border-success col-md-12">
            <div class="card-body">
                <h4 class="card-title">Update stampDuty</h4>
                <p class="card-text">
                <form action="{{ route('stampDuties.update',$stampDuty) }}" class="row" enctype="multipart/form-data" method="post">
                    <div class="row">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control custom-select" name="land_id">
                                <option value="{{$stampDuty->land->id}}">{{$stampDuty->land->title_deed}}</option>
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <select class="form-control custom-select" name="user_id">
                                <option value="{{$stampDuty->user->id}}" > {{$stampDuty->user->name}}</option>
                    ...
                    <div class="form-group col-md-4">
                        <input type="text" hidden name="status" value="{{$stampDuty->status}}">
                    </div>
